...
import com.chad.library.adapter.base.listener.OnHeaderClickListener;
import com.chad.library.adapter.base.listener.OnItemTouchListener;
    ...
    if (pinnedHeaderPosition >= 0 && mPinnedHeaderPosition != pinnedHeaderPosition) {
      ...
      if (mItemTouchListener == null) {
        ...
        try {
          ...
          final ArrayList<OnItemTouchListener> touchListeners =
              (ArrayList<OnItemTouchListener>) field.get(parent);
