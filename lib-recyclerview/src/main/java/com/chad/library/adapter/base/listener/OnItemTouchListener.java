...
import com.chad.library.adapter.base.entity.ClickBounds;
...
public class OnItemTouchListener implements RecyclerView.OnItemTouchListener {
  ...
  @Override public boolean onInterceptTouchEvent(final RecyclerView rv, MotionEvent event) {
  ...
  private class GestureListener extends GestureDetector.SimpleOnGestureListener {
    ...
    @Override public boolean onDown(MotionEvent e) {
      ...
      float downY = e.getY();
      final ClickBounds bounds = mBoundsArray.valueAt(0);
      mDownInside = downX >= bounds.getLeft()
          && downX <= bounds.getRight()
          && downY >= bounds.getTop()
          && downY <= bounds.getBottom();
